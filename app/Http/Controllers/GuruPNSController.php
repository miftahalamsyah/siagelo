...
class GuruPNSController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'nim'                   => 'required|numeric|unique:guru_p_n_s',
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'nim'                   => 'required|numeric|',Rule::unique('guru_p_n_s')->ignore($id),
            'no_hp'                 => 'required|numeric',
            'alamat'                => 'required'
        ];
        ...
        Alert::success('Berhasil', 'Guru NIM berhasil diubah');
